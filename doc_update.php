...
if (isset($_GET['updateid'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE doctors SET name=?, email=?, phone_no=?, address=?, department=? WHERE id=?";
        ...
        mysqli_stmt_bind_param($stmt, 'sssssi', $name, $email, $phone_no, $address, $department, $id);
    ...
    <form method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="department" name="department" value="<?php echo htmlspecialchars($row['department']); ?>" required></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center;">
                    <button type="submit" class="btn-primary" name="submit">Update</button>
                    <a href="doctors.php" class="btn-primary">Back to List</a>
                </td>
            </tr>
        </table>
    </form>
